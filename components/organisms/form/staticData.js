...
export const levelFormFields = [
    {label: 'Level 1', placeholder: 'Lorem Ipsum', type: 'select', iconSrc: '/assets/arrow-down-3101.svg', options: ['Lorem Ipsum', 'Lorem Ipsum']},
    {label: 'Level 2', placeholder: 'Lorem Ipsum', type: 'select', iconSrc: '/assets/arrow-down-3101.svg', options: ['Lorem Ipsum', 'Lorem Ipsum']},
    {label: 'Level 3', placeholder: 'Lorem Ipsum', type: 'select', iconSrc: '/assets/arrow-down-3101.svg', options: ['Lorem Ipsum', 'Lorem Ipsum']},
    {label: 'Level 4', placeholder: 'Lorem Ipsum', type: 'select', iconSrc: '/assets/arrow-down-3101.svg', options: ['Lorem Ipsum', 'Lorem Ipsum']},
]
